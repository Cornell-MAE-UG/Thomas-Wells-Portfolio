...
![ECG Block Diagram]({{ "/assets/images/ECG Model/ECG_Block_Diagram.png" | relative_url }}){: .inline-image-r}
...
![Single Heartbeat]({{ "/assets/images/ECG Model/Single_Heartbeat.png" | relative_url }}){: .inline-image-r}
...
![Single Heartbeat]({{ "/assets/images/ECG Model/Frequency_Response.png" | relative_url }}){: .inline-image-r}
